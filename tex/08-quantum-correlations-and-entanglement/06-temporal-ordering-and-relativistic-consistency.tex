\subsection{Temporal Ordering and Relativistic Consistency}
  ...
  \begin{tcolorbox}[
    ...
    In the Cosmochrony framework, no such bidirectional temporal dynamics is
    required.
    The appearance of time-symmetric correlations follows instead from the
    non-injective character of projection: a single underlying $\chi$
    configuration may admit multiple effective descriptions, constrained globally
    by consistency rather than by sequential temporal evolution.

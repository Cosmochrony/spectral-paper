\subsection{Summary}
  ...
  \begin{itemize}
    ...
    the limits of local projectability imposed by a globally non-injective relational
    structure.
  \end{itemize}
  ...
  interaction structure of the Standard Model, while classical behavior emerges as
  the limiting case of maximal projective injectivity.

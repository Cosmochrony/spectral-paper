\subsection{Non-Injective Projection, Entanglement, and Structural Transitions}
  \label{subsec:noninjective-projection-entanglement}

  The non-injective character of the projection from the \(\chi\)-substrate to effective
  observable descriptions plays a central role in the emergence of quantum phenomena in
  Cosmochrony.
  ...
  the non-injective projection from relational configurations of \(\chi\) to effective
  observables.
  They differ not in the nature of the underlying substrate, but in the stability
  properties of the projected description under admissible interactions and fluctuations.

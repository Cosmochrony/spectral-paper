...
\paragraph{Relaxation (of the $\chi$ field)}
  Relaxation refers to the intrinsic dynamical tendency of the $\chi$ field to continuously
  extend and reorganize its configuration under its internal coupling constraints.
  This process is geometric and pre-thermodynamic in nature: it does not correspond to
  dissipation, heat flow, or entropy maximization.
  Localized configurations that resist this expansive relaxation give rise to stable
  excitations, while spatial gradients store a fraction of the global relaxation budget.

...
\abstract{
  ...
  background. Strong interactions and confinement are shown to follow from the
  ...
  $\alpha$ acts as a universal spectral invariant, linking particle-scale stability
  to strong-gravity relaxation thresholds. At cosmological scales, Cosmochrony provides

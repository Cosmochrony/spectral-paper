...
\abstract{
  ...
  entity $\chi$, whose effective projections admit a scalar-field description.
  ...
  Gravitational and electromagnetic interactions are interpreted as complementary
  manifestations of relaxation gradients and structured deformations of the same
  underlying substrate, while gravitational waves correspond to propagating collective
  modulations of $\chi$.
  ...
  and strong-gravity relaxation thresholds.
    In this view, $\alpha$ encodes a regime-independent ratio between bound and critical
  relaxation modes, providing a continuous link between quantum excitations and
  black-hole-scale phenomena.

  At cosmological scales, Cosmochrony provides a unified interpretation of cosmic

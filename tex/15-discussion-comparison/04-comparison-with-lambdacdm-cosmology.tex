\subsection{Comparison with \texorpdfstring{$\Lambda$}{Λ}CDM Cosmology}
  ...
  For clarity, Table~\ref{tab:comparison_cosmochrony} summarizes the
  conceptual and ontological differences between Cosmochrony, the standard
  $\Lambda$CDM model, and Loop Quantum Gravity.

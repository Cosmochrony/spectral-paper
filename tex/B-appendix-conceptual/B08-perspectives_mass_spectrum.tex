...
\subsection{Spectral Scaling and the Projection Ontology}
  ...
  \paragraph{Mass as Spectral Weight}
    The non-injective nature of the projection $\Pi$ (see Section~4.2) implies that
    any effective particle in $\chi_{\mathrm{eff}}$ corresponds to a large
  ...
  \paragraph{Conclusion}
    ...
    projection, rather than as an arbitrary fundamental constant.

...
\subsection{Strong Gravity and Black Holes}
  ...
  \subsubsection{Black Holes, Deprojection, and Vacuum Reprojection}
    ...
    While smooth metric evolution ceases, the χ substrate remains structurally active.
...
\subsubsection{Horizon Reprojection Equation}
  ...
  by which structural energy stored in the χ substrate is released into the projected
  ...
  The times $t_k$ label the instants at which local χ configurations reach the
...
\subsubsection{Emergent Temperature and Relaxation Gradient}
  ...
  It is determined by the gradient of effective χ relaxation normal to the horizon.
...
\subsubsection{Information Conservation and Spectral Encoding}
  ...
  freedom of the χ substrate, encoded within the projection fiber.
  During reprojection, the emitted radiation carries the precise spectral imprint of
  the eigenmodes governing the χ configuration.

\subsection{Relation to Observational Units and Numerical Estimates}
  ...
  \subsubsection{Hubble Constant}
    ...
    to reproduce the electron mass $m_e \approx 9.11 \times 10^{-31} \, \text{kg}$.
    This tiny value suggests that $\lambda$ may be dynamically generated rather than fundamental.

\section{Theoretical Context and Motivation}
  ...
  \subsection{Minimalism as a Guiding Principle}
    ...
    independent quantization rules, we explore whether a single continuous scalar
    quantity can account for both temporal ordering and spatial relations.
  ...
  \subsection{Scope and Limitations}
    ...
    and limitations.
    In the following section, we introduce the scalar quantity $\chi$ formally and specify
    the minimal assumptions underlying its dynamics.

\section{Relational Distance as a Minimal Path Functional}
  ...
  \subsection{Combinatorial vs.\ weighted distance.}
    ...
    \begin{enumerate}
      ...
      \]
      where $w_{uv}$ denotes the positive weight associated with each link. This distance is used
      for the \textbf{emergent geometry} (particularly for spectral constructions)

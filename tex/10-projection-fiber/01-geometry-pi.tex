\subsection{The Geometry of the \texorpdfstring{$\Pi$}{Π} Subspace}
  ...
  from the minimal compact geometry required to support non-injective yet stable projections.
  ...
  large-$N$ limit of the discrete relational structure, in which coarse-grained spectral properties dominate.

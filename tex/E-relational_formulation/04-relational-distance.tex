\subsection{Relational Distance as a Minimal Path Functional}
  ...
  defined \emph{within} the $\chi$-network, without presupposing any embedding space.
  ...
  \paragraph{Combinatorial vs.\ weighted distance.}
    We define:
    ...
    \begin{enumerate}
      ...
      This distance counts \emph{graph steps only} and is \textbf{independent of the field values of $\chi$}.
      It is used to define the neighborhood sets employed in relational averaging.
  ...
  \paragraph{Weight functional and positivity.}

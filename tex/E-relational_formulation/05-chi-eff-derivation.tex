\subsection{Derivation of $\chi_{\mathrm{eff}}$ from Relational Observables}
  ...
  \paragraph{(1) Relational background field $\bar{\chi}$.}
...
of any weighted metric} and therefore does not depend on $\chi$ through a distance functional.
  ...
  \paragraph{(3) Effective field $\chi_{\mathrm{eff}}$ (geometry-aware coarse-graining).}

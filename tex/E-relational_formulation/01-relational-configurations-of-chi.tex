\subsection{Relational Configurations of \texorpdfstring{$\chi$}{χ}}
  ...
  This appendix develops the fully relational formulation of $\chi$ configurations,
  building on the definition established in
  Section~\ref{subsec:definition-of-the-chi-field}.
  Here, the $\chi$ substrate is characterized entirely by internal structural
  relations, without assuming coordinates, distances, durations, or background
  geometric notions.

\section{Relational Formulation of $\chi$ Dynamics}
  ...
  \subsection{Relational Configurations of $\chi$}
    ...
    At the most fundamental level, the $\chi$ field is described as a global
    configuration, without reference to spacetime points or coordinates.
    Physical distinctions arise only through relational differences between
    configurations, not through localization in a pre-existing manifold.

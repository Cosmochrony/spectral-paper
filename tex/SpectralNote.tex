...
\begin{document}
  ...
  \section{Spectral Decomposition via Representation Theory}
    ...
    \subsection{Eigenvalues of the Adjacency Operator}
      ...
      \paragraph{2D sector.}
        ...
        $\mathrm{tr}(\rho_4(i)) =
        \mathrm{tr}\bigl(\begin{smallmatrix}i&0\\0&-i\end{smallmatrix}\bigr) = 0$,
  ...
  \subsection{Non-perturbative DBI envelope}
    ...
    Substituting into the discrete DBI Lagrangian yields the exact
    one-mode Lagrangian
    \begin{equation}
      L(q,\dot q)
      =
      -c_\chi^2
      \sum_{v\in Q_8}
      \sqrt{1-\frac{\dot q^2\psi_n(v)^2}{c_\chi^2}}
      -
      \frac12\lambda_n q^2 .
      \label{eq:exact-mode-lagrangian}
    \end{equation}

...
% and outlines the programme toward SU(2) emergence via bounded flux.
  ...
  The present note establishes the first four stages of the spectral
  admissibility programme on the $Q_8$ Cayley graph.
  ...
  \paragraph{Step 4: structural origin of the admissibility hierarchy.}
    Section~\ref{sec:step4} shows that the hierarchy observed on the $Q_8$
    Cayley graph has a precise algebraic origin.
    The non-abelian quaternionic sector satisfies $\mu_{\rho_4}=0$,
    placing it at the centre of the adjacency spectrum and
    yielding the smallest non-trivial Laplacian eigenvalue.
    This structural property explains why bounded relational flux favours the
    $\rho_4$ sector and suggests a possible connection with the
    $\mathrm{SU}(2)\cong S^3$ geometry associated with spin.

  \paragraph{Step 5: dynamical survival of spectral sectors.}
    The next step is to simulate the full $Q_8$ substrate with the DBI
  ...
  \paragraph{Step 6: extension to larger graphs.}

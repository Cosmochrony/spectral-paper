...
of any weighted metric} and therefore does not depend on $\chi$ through a distance functional.
  ...
  \subsection{Non-circular dependency structure.}
    ...
    The effective geometry is encoded in $d^{W}$ through weights that depend only on $\bar{\chi}$, breaking any
    ...
    the procedure is purely kinematical and defines the conditions under which an effective

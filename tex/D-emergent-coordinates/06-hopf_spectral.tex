\subsection*{Spectral benchmark on $S^3$ and Hopf-compatible diagnostics}
  ...
  \paragraph{Hopf-compatible splitting.}
    ...
    The associated $k=1$ eigenspace (dimension $4$)
    may be organized as a singlet plus triplet under
    $\mathrm{SO}(3)$ acting on the base.
    This is interpretative and does not affect the eigenvalue ratio.

...
% Arrows
  ...
  \subsubsection*{Analytical Foundation and Statistical Isotropy}
    ...
    \end{equation}
    This statistical argument explains why the normalized response in Eq.~\eqref{eq:normalized_ratio} approaches $8/3$
    in the Hopf-compatible regime.
    It is consistent with the exact continuous Laplacian ratio on $S^3$ derived in Appendix~\ref{sec:analytical_ratio}.

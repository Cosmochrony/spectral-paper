\section{Emergent Coordinates via Manifold Reconstruction}
  ...
  \subsection{MDS embedding from relational distances}
    ...
    (reflections, translations, and rotations), which carry no physical
  ...
  \subsection{Intrinsic dimension from the eigenvalue gap}
    ...
    schematically in Fig.~\ref{fig:eigenvalue-gap}.
  ...
  \subsection{Breakdown as a physical prediction}
    ...
    \paragraph{Emergence of field equations.}
      ...
      \emph{projected} relational relaxation dynamics around quasi-homogeneous
      configurations.
    ...
    \paragraph{Conceptual role.}
      ...
      \input{D-emergent-coordinates/01-example-of-a-robust-spectral-ratio-in-a-relational-laplacian}

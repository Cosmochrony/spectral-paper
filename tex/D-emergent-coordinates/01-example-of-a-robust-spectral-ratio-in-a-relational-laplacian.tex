...
% Arrows
  ...
  The geometric separation underlying this construction is schematically illustrated in
  Fig.~\ref{fig:hopf_schematic}.
  ...
  \begin{figure}[t]
    ...
    \caption{
      ...
      \langle\sin^2\rangle$ toward the universal value $8/3$ for uniform sampling
      on $S^3$.
      ...
      The convergence illustrates the robustness of the ratio and its independence
      from discretization details.
    }
    \label{fig:convergence-8-3-s3}
  \end{figure}

  The robustness of this ratio can be explicitly verified numerically through independent Monte-Carlo sampling on
  $S^3$, as shown in Fig.~\ref{fig:convergence-8-3-s3}.

  This construction is not assumed to be unique nor fundamental.
  ...
  \subsubsection*{Spectral Observable and Monte--Carlo Estimator}
    ...
    The behavior of the kernel-weighted energies as a function of $\alpha$ is shown in
    ...
    The agreement between Monte--Carlo and spectral estimators is illustrated in
  ...
  \subsubsection*{Emergence of the \texorpdfstring{$8/3$}{8/3} Ratio}
    ...
    The normalized spectral response revealing the convergence toward $8/3$ is shown in
  ...
  \subsubsection*{Numerical Convergence in the Continuum Limit}
    ...
    This convergence should be understood in an operational sense.
    It indicates that the discrete relational Laplacian reproduces a stable
    ...
    This distinction is consistent with the effective and regime-dependent
    status of geometric descriptions in the Cosmochrony framework.

  \subsubsection*{Computational Protocol and Reproducibility}
    \label{subsec:computational_protocol}

    The numerical convergence of the spectral ratio toward $8/3$ as a function of
    substrate resolution is summarized in Table~\ref{tab:convergence}.
  ...
  \subsubsection*{Interpretation}
    ...
    relational and topological constraints, independently of any imposed geometric background

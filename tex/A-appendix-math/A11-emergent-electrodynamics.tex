\subsection{Emergent Electrodynamics from $\chi$ Dynamics}
  ...
  \paragraph{Scalar and Vector Potentials}
    ...
    \begin{itemize}
      ...
      $\nabla \times \nabla \chi \neq 0$), which are inherently divergence-free due to the solitonic topology
      (Section~\ref{subsec:vortices}).
    \end{itemize}
  ...
  \paragraph{Gauge Invariance}
    ...
    leaves the fields $\mathbf{E}$ and $\mathbf{B}$ invariant. This \textbf{U(1) gauge symmetry} is
        ...
        are observable (Section~\ref{subsec:relational-foundation-pointer}).

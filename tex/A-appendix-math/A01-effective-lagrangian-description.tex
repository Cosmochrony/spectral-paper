...
meaningful.}
  ...
  \subsubsection*{Hydrodynamic Limit and Emergent Geometry}
    ...
    \textit{No notion of geodesic motion or metric compatibility is implied at this stage.}
  ...
  \subsubsection*{Effective Lagrangian Representation}
    ...
    This step is purely representational and does not assume the validity of a variational principle at the fundamental
    level.

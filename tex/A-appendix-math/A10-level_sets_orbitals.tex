\subsection{Level Sets, Projections, and Apparent Orbital Geometry}
  ...
  physical interpretation or dynamical assumption.
  ...
  \noindent
  \emph{The present analysis addresses only the geometric and projective origin of
  orbital-like patterns.
  It does not concern the energetic ordering of such patterns, which arises from
  relaxation resistance and spectral constraints discussed elsewhere.}
  ...
  \subsubsection*{Non-Uniqueness of Inverse Reconstruction}
    ...
    The present analysis therefore establishes a structural constraint on
    reconstruction, not a reconstruction algorithm.
  ...
  \subsubsection*{Summary}
    ...
    criteria rather than fundamental discontinuity, localization, or energetic

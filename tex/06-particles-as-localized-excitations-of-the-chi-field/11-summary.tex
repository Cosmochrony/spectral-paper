\subsection{Summary}
  ...
  wavefunction.
  This topological structure provides a unified origin for spin-$\tfrac{1}{2}$
  behavior, fermionic antisymmetry, and the Pauli exclusion principle, without invoking
  additional quantum axioms or intrinsic spin degrees of freedom~\cite{Pauli1925,Dirac1928}.

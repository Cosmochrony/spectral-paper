\section{Testable Predictions and Observational Signatures}
  ...
  \subsection{Gravitational Wave Propagation}
    ...
    a few to ten percent, depending on the local $\chi$ correlation length $\xi$ and on
    the effective relaxation fraction $\Omega_\chi$ in the vicinity of the source.

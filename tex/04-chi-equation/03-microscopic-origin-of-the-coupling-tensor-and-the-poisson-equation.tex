\subsection{Microscopic Origin of the Coupling Tensor and the Poisson Equation}
  ...
  \paragraph{Status of effective equations.}
    ...
    for the gravitational potential or the wave equations describing solitonic excitations—
    are valid only within regimes where χ admits a smooth, weak-gradient geometric
    interpretation. They arise from coarse-graining the underlying χ relaxation dynamics
    and do not represent fundamental postulates of the theory.

    In particular, these equations should not be confused with the intrinsic relaxation
    equation governing χ at the pre-geometric level. Their domain of applicability is
    limited to configurations close to local equilibrium, where an effective spacetime
    description becomes meaningful.

\section{Ontological Interpretation of the $\chi$ Field}
  ...
  \subsection{The Role of $\hbar_{\chi}$ and Reprojection from $\chi$}
    ...
    In Cosmochrony, the constant $\hbar_{\chi}$ characterizes the minimal granularity
    by which structural indeterminacy within the $\chi$ substrate can be projected
    into emergent relational degrees of freedom.
